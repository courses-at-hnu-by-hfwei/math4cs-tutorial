...
\begin{problem}[一阶谓词逻辑: 前束范式]
  ...
  \begin{enumerate}
    \item[(R1)] $\lnot \forall x\; \alpha \equiv \exists x\; \lnot \alpha$;
    \item[(R2)] $\lnot \exists x\; \alpha \equiv \forall x\; \lnot \alpha$;
    \item[(R3)] $\alpha \to \forall x\; \beta \equiv \forall x\; (\alpha \to \beta)$,
      其中 $x$ 不在 $\alpha$ 中自由出现;
    \item[(R4)] $\alpha \to \exists x\; \beta \equiv \exists x\; (\alpha \to \beta)$,
      其中 $x$ 不在 $\alpha$ 中自由出现;
    \item[(R5)] $(\forall x\; \alpha) \to \beta \equiv \exists x\; (\alpha \to \beta)$,
      其中 $x$ 不在 $\beta$ 中自由出现;
    \item[(R6)] $(\exists x\; \alpha) \to \beta \equiv \forall x\; (\alpha \to \beta)$,
      其中 $x$ 不在 $\beta$ 中自由出现.
  \end{enumerate}
